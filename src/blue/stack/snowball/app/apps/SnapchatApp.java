...
public class SnapchatApp extends BaseApp implements NotificationProcessor {
	...
	void initMessageProcessors() {
		addMessageProcessor(new MessageProcessorBuilder()
				.setInputFormat(
						new InputFormatBuilder().setInputTemplateFromPackage(PACKAGE_NAME, "notification_ticker_text")
				...
				.addOutputFormat(
						"message",
						new OutputFormatBuilder().setOutputTemplateFromResouce(R.string.snapchat_new_message).build(
								this.context)).build(this.context));
		addMessageProcessor(new MessageProcessorBuilder()
				.setInputFormat(
						new InputFormatBuilder()
								.setCanonicalInputTemplateFromPackage(PACKAGE_NAME, "notification_ticker_text")
